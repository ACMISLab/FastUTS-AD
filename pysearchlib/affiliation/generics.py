...
def convert_vector_to_events(vector=[0, 1, 1, 0, 0, 1, 0]):
    ...
    # positive_indexes = np.argwhere(np.asarray(vector) > 1)
    events = []
...
def read_all_as_events():
    ...
    :return: two dictionaries:
        - the first containing the list of events for each m_dataset and algorithm,
        - the second containing the range of the series for each m_dataset
    """
