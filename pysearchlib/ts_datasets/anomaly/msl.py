...
from pysearchlib.ts_datasets.anomaly.smd import download, combine_train_test_datasets
from pysearchlib.ts_datasets.anomaly.smap import preprocess, load_data
...
class MSL(TSADBaseDataset):
    ...
    def __init__(self, subset=None, rootdir=None):
        ...
        # Download the SMAP m_dataset if it doesn't exist
