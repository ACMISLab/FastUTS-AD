...
from pysearchlib.utils.util_timeseries_sliding_windows import unroll_ts_torch, unroll_ts
...
class TestTimeSeries(TestCase):
    ...
    def test_unroll_ts(self):
        ...
        run_time = timeit.timeit("unroll_ts_torch(torch.eye(3000))",
                                 setup="from pysearchlib.utils.util_timeseries_sliding_windows import unroll_ts_torch, unroll_ts;import torch; ",
                                 number=10)
        print("unroll_ts_torch：", run_time)

        run_time = timeit.timeit("unroll_ts(np.eye(3000))",
                                 setup="from pysearchlib.utils.util_timeseries_sliding_windows import unroll_ts_torch, unroll_ts;import torch; import numpy as np;",
                                 number=10)
