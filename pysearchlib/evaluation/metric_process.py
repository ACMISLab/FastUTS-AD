...
from pysearchlib.evaluation.contextual import contextual_confusion_matrix
from pysearchlib.evaluation.utils import from_list_points_labels
from pysearchlib.utils.util_log import get_logger
from pysearchlib.utils.utils import get_random_file_name
...
class MetricHelper:
    ...
    def _report_final_metric(self, save_to_file=False):
        ...
        if save_to_file:
            ...
            UtilSys.is_debug_mode() and log.info(f"Save final metric to {os.path.abspath(rf)}")
        return final_metric
