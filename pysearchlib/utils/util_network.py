...
from pysearchlib.utils.util_bash import exec_cmd, exec_cmd_and_return_str

from pysearchlib.utils.util_log import get_logger, loginfo
from pysearchlib.utils.util_message import log_warn_msg
from pysearchlib.utils.util_system import UtilSys

log = get_logger()


def get_host_ip(dns_server='8.8.8.8', dns_port=80):
    """
    查询本机ip地址
    Returns
    str
...
def is_port_listing(port, host='127.0.0.1'):
    s = None
    try:
