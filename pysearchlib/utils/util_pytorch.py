...
from pysearchlib.dataset.AIOpsDataset import AIOpsDataset
from pysearchlib.utils.util_log import get_logger
from pysearchlib.utils.util_message import log_setting_msg
import torch
...
def get_select_one_gpu_index(exp_sequence, gpus: str) -> int:
    ...
    UtilSys.is_debug_mode() and log.info(f"Target gpus index: {selected_gpu}")
    return selected_gpu
