...
from pysearchlib.common import ConstDataset
from pysearchlib.util_pandas import create_pandas_sqlite_connection
...
def load_data(name,
    ...
    --------
    # Load all test set
    x_train,y_train=load_data("data",dataset_type=1,test_size=0)
...
def load_odds_data_two_splits(dataset_name,
    ...
    --------
    # Load all test set
    x_train,y_train=load_data("dataset_name",dataset_type=1,test_size=0)
