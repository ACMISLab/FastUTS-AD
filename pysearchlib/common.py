...
# todo: to remove this class gradually.
# Metrics
class Metric:
...
class Config:
    # The index of the GPU to use for training. e.g., str "0,1" means to use the first and second GPU to train the
    ...
    def get_values(args, key):
        ...
        args : argparse.Namespace
            通过 parser.parse_args() 获取到的 Namespase
        key : str
            要获取的值的 key， 如 -file
...
class KpiFiles:
    """
    The file user of train set must be start with train_xxx.
