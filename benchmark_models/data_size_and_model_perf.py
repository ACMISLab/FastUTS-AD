...
from pysearchlib.share.exp_helper import load_model
...
from pysearchlib.utils.util_picture import UtilPic
from pysearchlib.share.dataset_loader import get_debug_datasize
...
out_metrics = []
# for _model_name in ["lstm", "cnn", "vae", "ae", "coca", "decision_tree", "ocsvm", "hbos", "pca", "lof", "iforest", 'random_forest']
for _model_name in ["ocsvm", "pca", "iforest"]:
    ...
    for train_x, train_y, test_x, test_y in get_debug_datasize(window_size, is_include_anomaly_window):
        ...
        from pysearchlib.utils.util_univariate_time_series_view import UTSPlot
