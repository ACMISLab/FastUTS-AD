...
from benchmark_models.tadgan.TadGAN import model
...
class TadGanEd:
    ...
    def fit(self, X, y=None):
        ...
        for epoch in range(self.conf.num_epochs):
            ...
            UtilSys.is_debug_mode() and log.info('Critic training done in epoch {}'.format(epoch))
            encoder_loss = list()
            decoder_loss = list()
            ...
            UtilSys.is_debug_mode() and log.info('Encoder decoder training done in epoch {}'.format(epoch))
