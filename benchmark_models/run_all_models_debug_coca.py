...
from benchmark_models.model_utils import get_all_models, load_model, ExpConf
...
for model_name in models:
    ...
    uv = UnivariateTimeSeriesView(name=econf.model_name, dataset_name=econf.dataset_name, dataset_id=econf.data_id,conf=econf,
                                  is_save_fig=True)
