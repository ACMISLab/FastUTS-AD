...
class KNN:
    ...
    metric : string or callable, default 'minkowski'
        ...
        efficient than passing the metric dataset_name as a string.
    ...
    def fit(self, X, y=None):
        ...
        if X.shape[0] < self.n_neighbors:
            warnings.warn("Input.shape[0] is less than the number of neighbors")
    ...
    def score(self, X):
        ...
        if self.tree_ is None:
            return np.asarray(np.zeros(shape=(X.shape[0])))
